...
function TestimonialCards() {
  return (
    <div className="bg-white mr-2 gap-4 sm:w-[80%] md:w-[45%] lg:w-[30%] rounded-3xl md:mt-10 mt-2 p-4 shadow-md ">
      ...
      <img src='../Images/quote.png' alt='quote' className=" ml-64 mt-10 w-12 h-12"></img>
